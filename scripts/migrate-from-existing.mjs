 ...
 */
export const DEFAULT_TAGS = ["v0.7.0", "v0.8.0", "v0.9.0", "v0.10.0", "v0.11.0", "v0.12.0", "v0.13.0"];
// The NEWEST entry is DECLARED BEFORE IT IS CUT, on purpose (RELPTR-2) — `v0.13.0` today, `v0.11.0`
