...
describe("staging Neo4j replacement owner", () => {
  ...
  it.each([
    ...
    ["credentials", { targetCredentialFingerprint: GOOD.sourceCredentialFingerprint }],
    ["credential key ID", { targetCredentialFingerprint: { ...GOOD.targetCredentialFingerprint, keyId: "other-key" } }],
    ["missing source credential", { sourceCredentialFingerprint: null }],
