        ...
        <div className="rounded-2xl bg-surface-inset px-8 py-10">
          <div className="mb-4 flex items-center gap-3">
            ...
            <h2 className="text-xl font-semibold text-ink">
              Set up your AIOS workstation, {firstName}
            </h2>
          </div>
          <p className="mb-6 text-sm text-ink-secondary">
            Paste this into Claude Code, Claude Desktop, Cursor, Codex, or
            OpenCode. It inspects first, explains what exists, and pauses before
            updates, origin trust, secrets, or sharing.
          </p>
