 ...
 *  Exported so the criterion pins the CALL SITE's behaviour and not just the classifier's. */
export function diagnosisForLeg(error: string | null): { headline: string; action: string } | null {
